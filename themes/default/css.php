...
//check for background color
		...
		$background_color = "background: #ffffff;\n";
                ...
                $highlight_color = $_SESSION['theme']['highlight_color']['text'];
                
                list($hr, $hg, $hb) = sscanf($highlight_color, "#%02x%02x%02x");
                
                $high_muted1 = "rgba($hr,$hg,$hb,.35)";
                $high_muted2 = "rgba($hr,$hg,$hb,.2)";
                $high_muted1a = "rgba($hr,$hg,$hb,.3)";
                $high_muted2a = "rgba($hr,$hg,$hb,.15)";
                
                if(isset($_SESSION['theme']['hover_color']['text'])) {
                    $hover_color = $_SESSION['theme']['hover_color']['text'];
                } 
?>
...
/* SIDE MENU: Begin ***********************************************************/
	...
	div#menu_side_container > div#menu_side_control_container a.menu_side_item_main {
		...
		font-family: <?php echo ($_SESSION['theme']['menu_main_text_font']['text'] != '') ? $_SESSION['theme']['menu_main_text_font']['text'] : 'arial'; ?>;
		font-size: <?php echo ($_SESSION['theme']['menu_main_text_size']['text'] != '') ? $_SESSION['theme']['menu_main_text_size']['text'] : '10.25pt'; ?>;
		color: #fff!important; <?php 
                //echo ($_SESSION['theme']['menu_main_text_color']['text'] != '') ? $_SESSION['theme']['menu_main_text_color']['text'] : '#fff'; 
                ?>;
		cursor: pointer;
		}
	...
	div#menu_side_container > a.menu_side_item_main > i.menu_side_item_icon {
		color: #fff;<?php 
                //echo ($_SESSION['theme']['menu_main_icon_color']['text'] != '') ? $_SESSION['theme']['menu_main_icon_color']['text'] : '#fd9c03'; 
                ?>;
	}
...
?>
        ...
        div#menu_side_container,.btn,.btn-default,input.formfld, select.formfld, textarea.formfld, .txt {
        ...
        .form-table .value-row-first td {
                border-top: solid 1px <?php echo $highlight_color; ?>!important;
                }
        .form-table .value-row-last td {
               border-bottom: solid 1px <?php echo $highlight_color; ?>!important;
               }
        .hud_box {    
                background-color:<?php echo $highlight_color; ?>!important;
                } 
        .list-header > th {
               border-bottom-color:<?php echo $highlight_color; ?>!important;
               }
        .list-row:nth-child(odd) > :not(.action-button) {        
               background:<?php echo $high_muted1; ?>!important;
               }

        .list-row:nth-child(even) > :not(.action-button) {        
                background:<?php echo $high_muted2; ?>!important;
                }
        .list-row:nth-child(odd) > td.description {
                background:<?php echo $high_muted1a; ?>!important;
                }

        .list-row:nth-child(even) > td.description {
                background:<?php echo $high_muted2a; ?>!important;
                }
        #default_login {
               border: solid 20px <?php echo $highlight_color; ?>!important;
               background-color: white!important;
               }
        select.txt, textarea.txt, input[type="text"].txt, input[type="number"].txt, input[type="password"].txt, label.txt, select.formfld, textarea.formfld, input[type="text"].formfld, input[type="number"].formfld, input[type="url"].formfld, input[type="password"].formfld, label.formfld {
               border: solid 1px <?php echo $highlight_color; ?>!important;               
               }       
        select.txt:hover, textarea.txt:hover, input[type="text"].txt:hover, input[type="number"].txt:hover, input[type="password"].txt:hover, label.txt:hover, select.formfld:hover, textarea.formfld:hover, input[type="text"].formfld:hover, input[type="number"].formfld:hover, input[type="url"].formfld:hover, input[type="password"].formfld:hover, label.formfld:hover {
...
if(isset($hover_color)) {
    echo "a:hover,#menu_side_container a:hover,option,optgroup { color: $hover_color!important } .btn:hover,.btn-default:hover { background: $hover_color!important }";
} else {
    echo "#menu_side_container a:hover { color: #333!important } .btn:hover,.btn-default:hover { background: #000!important } option,optgroup { color:black!important; }";
}
?>
