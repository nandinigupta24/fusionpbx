...
<link rel='stylesheet' type='text/css' href='/resources/uirework/rework.css'>
<script src='/resources/uirework/rework.js'></script>
</head>
<body>
...
.slider-light .slick-prev::before, .slider-light .slick-next::before {
...
.slick-prev {
    left:10px;
        ...
        <style> #default_login { text-align:left;box-shadow:none;height:auto!important;width:auto!important;position:static;transform:none;border:none!important;display:inline-block } #login_logo { margin-bottom:50px } </style>
        <div class='h-100 no-gutters row'>
          <div class='d-none d-lg-block col-lg-4 h-100'>
        <div class="slider-light h-100">
                             <div class="slick-slider">
                                <div>
                                    <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-premium-dark" tabindex="-1">
                                        <div class="slide-img-bg" style="background-image: url('/themes/default/images/bg1.jpg');"></div>
                                ...
                                <div>
                                    <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-premium-dark" tabindex="-1">
                                        <div class="slide-img-bg" style="background-image: url('/themes/default/images/bg2.jpg');"></div>
                                ...
                                <div>
                                    <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-premium-dark" tabindex="-1">
                                        <div class="slide-img-bg" style="background-image: url('/themes/default/images/bg4.jpg');"></div>
...
<script language='JavaScript' type='text/javascript' src='/resources/slick/slick.js'></script>
<script>rework();$('.slick-slider').slick({ dots: true,autoplay: true,autoplaySpeed: 2000,infinite:true});</script>
